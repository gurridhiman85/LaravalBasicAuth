...
<section id="offer-section">
    <div class="container">
        <div class="row new-offer">
            ...
            <div id="demo" class="col col-lg-8 carousel slide" data-bs-ride="carousel">
                <!-- Indicators -->
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item">
                        <img src="images/ads-1.jpg" alt="Chicago" class="d-block" style="width:100%">
                    </div>
                    <div class="carousel-item">
                        <img src="images/ads-1.jpg" alt="New York" class="d-block" style="width:100%">
                    </div>
                </div>
            </div>
